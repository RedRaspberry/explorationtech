...
mods.botania.RuneAltar.addRecipe(<ebwizardry:ethereal_crystalweave>, [<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "vitreus"}]}), <botania:manaresource:22> * 2, <ebwizardry:grand_crystal>, <thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "motus"}]})], 400);
